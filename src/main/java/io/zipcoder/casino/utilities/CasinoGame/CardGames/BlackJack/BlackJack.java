...
package io.zipcoder.casino.utilities.CasinoGame.CardGames.BlackJack;
...
public class BlackJack extends CardGame implements GamblingGame {
    ...
    private int[] surrogates = {0xD83D, 0xDC7D};
    private String alienEmojiString = new String(surrogates, 0, surrogates.length);
    //System.out.println(alienEmojiString);


    private BlackJackPlayer bjplayer;
    private BlackJackPlayer dplayer;

    private Hand playerhd;
    private Hand dealerhd;
