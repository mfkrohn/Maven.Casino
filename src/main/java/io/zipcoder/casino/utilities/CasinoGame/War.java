...
public class War extends CardGame implements Game {
    ...
    private class WarMethod {
        ...
        public WarMethod(Stack<Card> player1Hand, Stack<Card> player2Hand) {
            this.player1Hand = player1Hand;
            this.player2Hand = player2Hand;
        }

        public Card getP1WarCard1() {
            return p1WarCard1;
        }

        public Card getP1WarCard2() {
            return p1WarCard2;
        }

        public Card getP1WarCard3() {
            return p1WarCard3;
        }

        public Card getP1WarCard4() {
            return p1WarCard4;
        }

        public Card getP2WarCard1() {
            return p2WarCard1;
        }

        public Card getP2WarCard2() {
            return p2WarCard2;
        }

        public Card getP2WarCard3() {
            return p2WarCard3;
        }

        public Card getP2WarCard4() {
            return p2WarCard4;
        }

        public WarMethod invoke() {
