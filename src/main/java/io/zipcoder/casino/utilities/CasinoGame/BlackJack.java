    ...
    public void play() {
        ...
        while (bjplayer.getBalance() > 0) //keep playing as long as the player has money left
        {
            ...
            if (playerWish == 1) {
                ...
                console.println("Dealers Hidden Card is: " + dealerhd.getSecondcard());
                ...
                if ((dealerhd.getBlackJackValue() > playerhd.getBlackJackValue()
                        && endRound == false)) {
                    console.println("Dealers hand Value: " + dealerhd.getBlackJackValue());
                ...
                while (dealerhd.value < 17) {
                    ...
                    console.println("Dealer hand value after draw is " + dealerhd.getBlackJackValue());
                    mydeck.buildBlackJackDeck();
                }
